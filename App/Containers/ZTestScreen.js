...
const Words = {
  obama: {
    Who: ['myself', 'me', 'we', 'Americans', 'African_Americans', 'them', 'I', 'Bradley_Cooper', 'officers', 'federal_government', 'the_CIA', 'Chinese', 'British', 'NPR', 'her', 'the_DNC', 'somebody', 'you', 'the_Koch_brothers', 'the_United_States_senate', 'Chicagoans', 'democrats', 'Donald_Trump', 'people'],
    What: ['concerns', 'pride', 'history', 'problems', 'descrimination', 'country', 'relationship', 'agency', 'terrorism', 'revelation', 'vacation', 'substance', 'manipulation', 'consequence', 'climate_change', 'generation', 'races', 'presidency', 'fish_fries', 'party', 'bathrooms', 'obama_care', 'fries', 'it', 'states', 'chunks', 'challenge', 'issues', 'trust'],
    Descriptions: ['incredible', 'cafeful', 'most', 'sure', 'naive', 'legitamite', 'explicit', 'islamic', 'political', 'vulnerable', 'consistently', 'controversial', 'deep', 'passionate', 'lost', 'meaningful', 'big', 'public', 'salient', 'happy', 'proud', 'complicated', 'ignorant', 'hard'],
    Verbs: ['concerns', 'be', 'do', 'have', 'dont', 'steal', 'impact', 'call', 'like', 'read', 'avoid', 'doubt', 'contributed', 'lost', 'swirl', 'were', 'help', 'rise_up', 'start', 'campaign', 'leave', 'financing', 'think', 'races', 'hearing', 'felt', 'support', 'was', 'feel', 'had', 'spending', 'benefit', 'challenge', 'are', 'is', 'promote', 'give', 'made', 'has', 'party', 'talk', 'trust', 'builds'],
    ...
    Bonus: ['bitch', 'mother_fucker', 'Jim_Crow', 'nerd', 'and_and', 'trumped_up', 'fake_news', 'mother_fuckers', 'sorry_ass', 'well_uh', 'shit', 'damn_fries', 'whos_ass', 'noo', 'pussy', 'goddam', 'whatever']
  },
  trump: {
