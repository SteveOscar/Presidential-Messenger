...
const Words = {
  obama: {
    ...
    What: ['concerns', 'relationship', 'agency', 'terrorism', 'revelation', 'vacation', 'substance', 'manipulation', 'consequence', 'climate_change', 'generation', 'races', 'presidency', 'fish_fries', 'party', 'bathrooms', 'obama_care', 'fries', 'it', 'states', 'chunks', 'challenge', 'issues', 'trust'],
    ...
    Verbs: ['concerns', 'have', 'dont', 'steal', 'impact', 'call', 'like', 'read', 'avoid', 'doubt', 'contributed', 'lost', 'swirl', 'were', 'help', 'rise_up', 'start', 'campaign', 'leave', 'financing', 'think', 'races', 'hearing', 'felt', 'support', 'was', 'feel', 'had', 'spending', 'benefit', 'challenge', 'are', 'is', 'promote', 'give', 'made', 'has', 'party', 'talk', 'trust', 'builds'],
    Time: ['months', 'before', 'decade', 'among', 'now', 'after', 'always', 'twelve', 'forty_five', 'immediately', 'where'],
    Misc: ['and', 'on', 'what', 'in', 'a', 'maybe', 'of', 'by', 'to', 'the', 'any', 'if', 'at', 'actually', 'from', 'or', 'that', 'then', 'but', 'ughhh', 'for', 'so', 'who', 'because', 'wellll'],
  ...
  trump: {
    Who: ['Mexico', 'North_Korea', 'Asia', 'Pakistan', 'Paul_Manafort', 'Osama_Bin_Laden', 'Qatar', 'India', 'Saddam_Hussein', 'Russia', 'Sarah_Palin', 'President_Bush', 'Clinton', 'Iraq', 'I', 'me', 'South_Korea', 'the_USA', 'the_DNC', 'Homeland_Security', 'anybody', 'companies', 'everybody', 'The_United_States', 'Michigan', 'Pennsylvania', 'Bernie', 'them', 'Donald_Trump', 'fellas', 'ISIS', 'Chicago', 'president_Obama', 'Abe_Lincoln', 'the_CIA', 'others', 'somebody', 'you', 'president', 'they', 'you2', 'Afghanistan', 'democrats', 'women', 'people', 'fox', 'Sean'],
    What: ['primaries', 'disgrace', 'wife', 'life', 'father', 'pictures', 'the_world', 'scotch', 'dinner', 'profits', 'tattoos', 'drinking', 'regulations', 'truth', 'media', 'social_media', 'stories', 'time', 'drugs', 'king', 'ability', 'party', 'pill', 'emergency', 'plant', 'factories', 'deal', 'termination', 'terror', 'tax', 'bread', 'dollars', 'mess', 'college', 'work', 'audience', 'intelligence', 'problem', 'catastrophe', 'victory', 'states'],
    Descriptions: ['correct', 'mellow', 'truly', 'terrible', 'drunk', 'involved', 'hard', 'amazing', 'done', 'great', 'well', 'dishonest', 'fake', 'bad', 'easier', 'tougher', 'disgraceful', 'massive', 'better', 'good', 'tremendous', 'properly', 'finished', 'legally', 'phenomenal', 'total', 'absolutely', 'fabulous', 'approved', 'smarter', 'unfairly', 'legitamite', 'illegal', 'strongly', 'dead'],
    ...
    Time: ['two', 'twenty_eight', 'million', 'tonight', 'back', 'then', 'now', 'through', 'seventy_one', 'today', 'six', 'trillion', 'before', 'years', 'never', 'here'],
    Misc: ['of', 'and', 'more', 'any', 'no', 'that', 'for', 'not', 'maybe', 'really', 'this', 'so2', 'there', 'so', 'then', 'by', 'please', 'ya_know', 'but', 'without', 'from', 'yes', 'who', 'to', 'wow', 'in'],
    Bonus: ['waterboarding', 'SS', 'hey', 'collusion', 'extreme_vetting', 'young_women', 'kick_ass', 'stone_cold_drunk', 'put_out', 'Arab', 'fake_news', 'frankly', 'tooo', 'damn', 'shitoutofthesea', 'bull_shit', 'pussy', 'but_uhh', 'ahhh', 'Mexico2', 'fair', 'at_all', 'heee']
  }
}
