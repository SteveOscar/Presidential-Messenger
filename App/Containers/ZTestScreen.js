...
const Words = {
  ...
  trump: {
    ...
    Bonus: ['waterboarding', 'SS', 'hey', 'collusion', 'Obamacare', 'extreme_vetting', 'young_women', 'kick_ass', 'stone_cold_drunk', 'put_out', 'Arab', 'fake_news', 'frankly', 'tooo', 'damn', 'shitoutofthesea', 'bull_shit', 'pussy', 'but_uhh', 'ahhh', 'Mexico2', 'fair', 'at_all', 'heee']
  }
}
