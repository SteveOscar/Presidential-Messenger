...
const Words = {
  obama: {
    ...
    Time: ['months', 'a_lot', 'then', 'years', 'one', 'a_third', 'ninety', 'percent', 'right_now', 'along', 'before', 'decade', 'among', 'now', 'after', 'always', 'twelve', 'forty_five', 'immediately'],
  ...
  trump: {
    Who: ['Mexico', 'Vietnam', 'we', 'Texas', 'China', 'he', 'the_sheriff', 'China2', 'North_Korea', 'Asia', 'Pakistan', 'Paul_Manafort', 'Osama_Bin_Laden', 'Qatar', 'India', 'Saddam_Hussein', 'Russia', 'Sarah_Palin', 'President_Bush', 'Clinton', 'Iraq', 'I', 'me', 'South_Korea', 'the_USA', 'the_DNC', 'Homeland_Security', 'anybody', 'companies', 'everybody', 'The_United_States', 'Michigan', 'Pennsylvania', 'Bernie', 'them', 'Donald_Trump', 'fellas', 'ISIS', 'Chicago', 'president_Obama', 'Abe_Lincoln', 'the_CIA', 'others', 'somebody', 'you', 'president', 'they', 'you2', 'Afghanistan', 'democrats', 'women', 'people', 'fox', 'Sean'],
    What: ['primaries', 'hating', 'spirit', 'killer', 'disgrace', 'wife', 'life', 'father', 'pictures', 'the_world', 'scotch', 'dinner', 'profits', 'tattoos', 'drinking', 'regulations', 'truth', 'media', 'social_media', 'stories', 'time', 'drugs', 'king', 'ability', 'party', 'pill', 'emergency', 'plant', 'factories', 'deal', 'termination', 'terror', 'tax', 'bread', 'dollars', 'mess', 'college', 'work', 'audience', 'intelligence', 'problem', 'catastrophe', 'victory', 'states'],
    Descriptions: ['correct', 'smart', 'mellow', 'killer', 'truly', 'terrible', 'drunk', 'involved', 'hard', 'amazing', 'done', 'great', 'well', 'dishonest', 'fake', 'bad', 'easier', 'tougher', 'disgraceful', 'massive', 'better', 'good', 'tremendous', 'properly', 'finished', 'legally', 'phenomenal', 'total', 'absolutely', 'fabulous', 'approved', 'smarter', 'unfairly', 'legitamite', 'illegal', 'strongly', 'dead'],
    Verbs: ['vote', 'can', 'get', 'was', 'obstruct', 'are', 'retire', 'dont', 'drink', 'say', 'do', 'shock', 'let', 'cannot', 'have', 'did_not', 'talk', 'party', 'pay', 'plant', 'is', 'leave', 'trade', 'deal', 'finished', 'created', 'cut', 'create', 'tax', 'look', 'think', 'spoke', 'work', 'does', 'shot', 'help', 'approve', 'forgot', 'did', 'demean'],
    ...
    Helpers: ['of', 'and', 'the', 'with', 'should', 'more', 'would', 'will', 'any', 'no', 'that', 'for', 'not', 'maybe', 'really', 'this', 'so2', 'there', 'so', 'then', 'by', 'please', 'ya_know', 'but', 'without', 'from', 'yes', 'who', 'to', 'wow', 'in'],
  ...
  offerPurchase() {
    ...
    InAppUtils.loadProducts(products, (error, products) => {
      ...
      if(!product) {
        ...
        Alert.alert(
          'Potus Mode Required',
          `Unlocks all bonus words and the ability to load/replay recorded phrases. One-time purchase of ${product.priceString}`,
          [
