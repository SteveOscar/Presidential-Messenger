...
const Words = {
  obama: {
    ...
    Misc: ['and', 'on', 'what', 'in', 'a', 'maybe', 'of', 'by', 'to', 'the', 'any', 'if', 'at', 'actually', 'from', 'or', 'dont', 'that', 'then', 'but', 'ughhh', 'for', 'so', 'who', 'because', 'wellll'],
  ...
  trump: {
    Who: ['Mexico', 'North_Korea', 'Pakistan', 'Osama_Bin_Laden', 'Qatar', 'India', 'Saddam_Hussein', 'Russia', 'Sarah_Palin', 'President_Bush', 'Clinton', 'Iraq', 'I', 'me', 'South_Korea', 'the_USA', 'the_DNC', 'Homeland_Security', 'anybody', 'companies', 'everybody', 'The_United_States', 'Michigan', 'Pennsylvania', 'Bernie', 'them', 'Donald_Trump', 'fellas', 'ISIS', 'Chicago', 'president_Obama', 'Abe_Lincoln', 'the_CIA', 'others', 'somebody', 'you', 'president', 'they', 'you2', 'Afghanistan', 'democrats', 'women', 'people', 'fox', 'Sean'],
    What: ['primaries', 'wife', 'profits', 'regulations', 'truth', 'media', 'social_media', 'stories', 'time', 'drugs', 'king', 'ability', 'party', 'pill', 'emergency', 'plant', 'factories', 'deal', 'termination', 'terror', 'tax', 'bread', 'dollars', 'mess', 'college', 'work', 'audience', 'intelligence', 'problem', 'catastrophe', 'victory', 'states'],
    Descriptions: ['correct', 'terrible', 'amazing', 'done', 'great', 'well', 'dishonest', 'fake', 'bad', 'easier', 'tougher', 'disgraceful', 'massive', 'better', 'good', 'tremendous', 'properly', 'finished', 'legally', 'phenomenal', 'total', 'absolutely', 'fabulous', 'approved', 'smarter', 'unfairly', 'legitamite', 'illegal', 'strongly', 'dead'],
    Verbs: ['vote', 'can', 'shock', 'let', 'cannot', 'have', 'did_not', 'talk', 'party', 'pay', 'plant', 'is', 'leave', 'trade', 'deal', 'finished', 'created', 'cut', 'create', 'tax', 'look', 'think', 'spoke', 'work', 'does', 'shot', 'help', 'approve', 'forgot', 'did', 'demean'],
    Time: ['two', 'twenty_eight', 'million', 'tonight', 'now', 'through', 'seventy_one', 'today', 'six', 'trillion', 'before', 'years', 'never', 'here'],
    Misc: ['of', 'and', 'more', 'that', 'for', 'not', 'maybe', 'really', 'this', 'so2', 'there', 'so', 'then', 'by', 'dont', 'do', 'please', 'ya_know', 'but', 'without', 'from', 'yes', 'who', 'to', 'wow', 'in'],
    Bonus: ['waterboarding', 'SS', 'hey', 'kick_ass', 'put_out', 'Arab', 'fake_news', 'frankly', 'tooo', 'damn', 'shitoutofthesea', 'bull_shit', 'pussy', 'but_uhh', 'ahhh', 'Mexico2', 'fair', 'at_all', 'heee']
  }
}
